...
`people` get imported via this to GT People content type

## Version 2 -- now a recipe for easier use

Conversion from module to recipe may have hiccups, but same ideas apply
...
[![GitHub Super-Linter](https://github.com/konfuzed/gtcos_drupal_people_migrate/workflows/Lint%20Code%20Base/badge.svg)](https://github.com/marketplace/actions/super-linter)
